...
namespace TheWeaponsPlatform
{
    public class TemplateGun : AdvancedGunBehavior
    {
        ...
        public static void Add()
        {
            ...
            internalName = $"{TheWeaponsPlatformMain.MODPREFIX}:{FULLNAME.ToID()}";
            ...
            /* OR */
            gun.gunSwitchGroup = $"{TheWeaponsPlatformMain.MODPREFIX}_{FULLNAME.ToID()}"; //Unique name for your gun's sound group. In this example it uses your console name but with an underscore.
            ...
            /* OR */
            gun.DefaultModule.customAmmoType = CustomClipAmmoTypeToolbox.AddCustomAmmoType("Template Gun Orbs", "TheWeaponsPlatform/Resources/CustomGunAmmoTypes/tempgun_clipfull", "TheWeaponsPlatform/Resources/CustomGunAmmoTypes/tempgun_clipempty");
            ...
            gun.shellCasing = BreakableAPIToolbox.GenerateDebrisObject("TheWeaponsPlatform/Resources/CustomGunAmmoTypes/tempgun_clipempty").gameObject; //Example using a custom sprite as a casing.
